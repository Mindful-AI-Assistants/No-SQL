...
## Step-by-Step Guide for VideoWall Database in DBeaver
...
- In DBeaver, create a new connection to your MySQL server and connect to this database.
...
### 5. Run Queries (DQL) to Test

Examples of useful queries to demonstrate system functionality:
